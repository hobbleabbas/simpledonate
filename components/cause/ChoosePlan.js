  ...
  return (
    <section className = 'w-full relative z-10 text-left max-w-screen-lg xl:max-w-screen-xl mx-auto' id = 'donate'>
        <div className = 'w-full px-4 sm:px-6 md:px-8 pb-24'>
            <section className = 'grid gap-x-4 grid-cols-3'>
                <div className = 'col-span-1 rounded-tr-xl sm:rounded-t-xl lg:rounded-xl shadow-lg p-4'>
                    <p className = 'text-blue-500 pb-4 text-xl'>BELIEVER PLAN</p>
                    <h3 className = 'text-3xl sm:text-3xl lg:text-3xl leading-none font-extrabold text-gray-900 tracking-tight mb-4'>
                        <span className = 'text-blue-600'>${props.bPlan}</span> Donation
                    </h3>
                    <p className = 'text-2xl font-bold'>{props.bBackers} Backers</p>
                ...
                <div className = 'col-span-1 rounded-tr-xl sm:rounded-t-xl lg:rounded-xl shadow-lg p-4'>
                    <p className = 'text-blue-500 pb-4 text-xl'>COMMITTED PLAN</p>
                    <h3 className = 'text-3xl sm:text-3xl lg:text-3xl leading-none font-extrabold text-gray-900 tracking-tight mb-4'>
                        <span className = 'text-blue-600 justify-items-center'>${props.cPlan}</span> Donation
                    </h3>
